...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    if (
      typeof currentUserType !== "undefined" &&
    ...
    try {
      ...
      if (verifyResult.success) {
        ...
        if (loginResult.success) {
          ...
          showError(
            "Đã xác thực thành công nhưng không thể đăng nhập. Vui lòng đăng nhập thủ công."
          );
          setTimeout(() => {
...
document
  .getElementById("back-to-register")
  .addEventListener("click", function () {
    showStep(1);
  });

const backToVerifyCandidate = document.getElementById(
  "back-to-verify-candidate"
);
